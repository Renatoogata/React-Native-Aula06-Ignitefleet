...
// definindo uma tarefa em banckground com o nome "location-tracking"
export const BACKGROUND_TASK_NAME = "location-tracking"

// passar pelo data, infos da localização atual, e error caso tenha algum erro
TaskManager.defineTask(BACKGROUND_TASK_NAME, async ({ data, error }: any) => {
  try {
    ...
    if (data) {
      // pegando os dados da localização
